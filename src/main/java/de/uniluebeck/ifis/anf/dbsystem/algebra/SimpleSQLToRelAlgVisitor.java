...
public class SimpleSQLToRelAlgVisitor extends ObjectDepthFirst
{
  ...
  /**
   * Remove unnecessary double quotes from the beginning and
   * end of a string (e.g. content of a database table).
   *
   * For example "Buch1" becomes Buch1.
   */
  private String removeQuotes(String content)
  {
    if (content.length() >= 3 &&
        ("\"").equals(String.valueOf(content.charAt(0))) &&
        ("\"").equals(String.valueOf(content.charAt(content.length() - 1))))
    {
  ...
  public Object visit(Query n, Object argu)
  {
    ...
    if (n.f4.present())
    {
      ...
      whereClause = (de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.AndExpression)n.f4.node.accept(this, columnNames);
    }

    this.executionPlan = de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.Relation.createSelection(selectItems, tableNames, whereClause);
    return null;
  }
  ...
  public Object visit(AndExpression n, Object argu)
  {
    ...
    for (Object node: n.f1.nodes)
    {
      ...
      de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.OrExpression orExpr =
              (de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.OrExpression)sequence.elementAt(1).accept(this, argu);
      list.add(orExpr);
    }
  ...
  public Object visit(OrExpression n, Object argu)
  {
    ...
    for (Object node: n.f2.nodes)
    {
      ...
      de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.EqualityExpression eqExpr =
              (de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.EqualityExpression)sequence.elementAt(1).accept(this, argu);
      list.add(eqExpr);
    }
    expr.setExpressions(list);
    return expr;
  ...
  public Object visit(Update n, Object argu)
  {
    ...
    de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.Table table =
    ...
    for (int i = 0; i < assignList.size(); ++i)
    {
      ...
      values[i] = this.removeQuotes(assignList.get(i)[1]);
    }
    ...
    if (n.f4.present())
    {
      updateOperation.setWhereClause((de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.AndExpression)n.f4.node.accept(this, columnList));
    }
  ...
  public Object visit(Delete n, Object argu)
  {
    ...
    if (n.f3.present())
    {
      deleteOperation.setWhereClause((de.uniluebeck.ifis.anf.dbsystem.algebra.nodes.AndExpression)n.f3.node.accept(this, columnList));
    }
  ...
  public Object visit(Insert n, Object argu)
  {
    ...
    // Set first value
    values.add(this.removeQuotes(n.f6.f0.toString()));
    ...
    for (Object nodeSeq: n.f6.f1.nodes)
    {
      ...
      values.add(this.removeQuotes(literal.toString()));
    }
